export class Vector extends PIXI.Point {
    ...
    // Interpolates between three vectors for a three point curve
    ...
    // Interpolates between four vectors for a bezier curve
